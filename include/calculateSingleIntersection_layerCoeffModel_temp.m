...
pdzdx = @(X,id,jd) (coeff{id,jd}(10)*3*X(1)^2 + coeff{id,jd}(9)*2*X(1)*X(2) + coeff{id,jd}(8)*X(2)^2 +...
    coeff{id,jd}(6)*2*X(1) + coeff{id,jd}(4)*X(2) + coeff{id,jd}(3));

pdzdy = @(X,id,jd) (coeff{id,jd}(9)*X(1)^2 + coeff{id,jd}(8)*2*X(1)*X(2) + coeff{id,jd}(7)*3*X(2)^2 + ...
    coeff{id,jd}(4)*X(1) + coeff{id,jd}(5)*2*X(2) + coeff{id,jd}(2));

pdzdxdx = @(X,id,jd) (coeff{id,jd}(10)*3*2*X(1) + coeff{id,jd}(9)*2*X(2) + coeff{id,jd}(6)*2);
pdzdxdy = @(X,id,jd) (coeff{id,jd}(9)*2*X(1) + coeff{id,jd}(8)*2*X(2) + coeff{id,jd}(4));
pdzdydy = @(X,id,jd) (coeff{id,jd}(8)*2*X(1) + coeff{id,jd}(7)*3*2*X(2) + coeff{id,jd}(5)*2);
